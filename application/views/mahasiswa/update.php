        ...
        <div class="row">
            ...
            <div class="col-md-6">
                <div class="col">
                    <div class="form-group">
                        ...
                        <input type="text" name="nim" class="form-control" id="nim" placeholder="NIM" value="<?= (set_value('nim')) ? set_value('nim') : $mhs['nim']; ?>" readonly>
                        <?= form_error('nim', '<small class="text-danger pl-3">', '</small>'); ?>
                    </div>
                    <div class="form-group">
                        <label for="nama">Nama Mahasiswa<span style="color:red;">*</span></label>
                        <input type="text" name="nama" class="form-control" id="nama" placeholder="Nama Mahasiswa" value="<?= (set_value('nama')) ? set_value('nama') : $mhs['nama']; ?>">
                    ...
                    <div class=" form-group">
                        ...
                        <input type="text" name="email" class="form-control" id="email" placeholder="***@gmail.com" value="<?= (set_value('email')) ? set_value('email') : $mhs['email']; ?>">
                        <?= form_error('email', '<small class="text-danger pl-3">', '</small>'); ?>
                    </div>
                    <div class="form-group">
                        <label for="no_telp">No Telepon<span style="color:red;">*</span></label>
                        <input type="text" name="no_telp" class="form-control" id="no_telp" placeholder="No HP Mahasiswa" value="<?= (set_value('no_telp')) ? set_value('no_telp') : $mhs['no_telp']; ?>">
                        <?= form_error('no_telp', '<small class="text-danger pl-3">', '</small>'); ?>
                    </div>
                    <div class="form-group">
                        <label for="alamat">Alamat Mahasiswa<span style="color:red;">*</span></label>
                        <input type="text" name="alamat" class="form-control" id="alamat" placeholder="Alamat Mahasiswa" value="<?= (set_value('alamat')) ? set_value('alamat') : $mhs['alamat']; ?>">
                        <?= form_error('alamat', '<small class="text-danger pl-3">', '</small>'); ?>
                    </div>
                    <div class="form-group">
                        <label for="nama_ayah">Nama Ayah</label>
                        <input type="text" name="nama_ayah" class="form-control" id="nama_ayah" placeholder="Nama Ayah" value="<?= (set_value('nama_ayah')) ? set_value('nama_ayah') : $mhs['nama_ayah']; ?>">
                        <?= form_error('nama_ayah', '<small class="text-danger pl-3">', '</small>'); ?>
                    </div>
                    <div class="form-group">
                        <label for="pekerjaan_ayah">Pekerjaan Ayah</label>
                        <input type="text" name="pekerjaan_ayah" class="form-control" id="pekerjaan_ayah" placeholder="Pekerjaan Ayah" value="<?= (set_value('pekerjaan_ayah')) ? set_value('pekerjaan_ayah') : $mhs['pekerjaan_ayah']; ?>">
            ...
            <div class="col-md-6">
                ...
                <div class="form-group">
                        ...
                        <input type="text" name="nama_ibu" class="form-control" id="nama_ibu" placeholder="Nama Ibu" value="<?= (set_value('nama_ibu')) ? set_value('nama_ibu') : $mhs['nama_ibu']; ?>">
                        <?= form_error('nama_ibu', '<small class="text-danger pl-3">', '</small>'); ?>
                    </div>
                    <div class="form-group">
                        <label for="pekerjaan_ibu">Pekerjaan Ibu</label>
                        <input type="text" name="pekerjaan_ibu" class="form-control" id="pekerjaan_ibu" placeholder="Pekerjaan Ibu" value="<?= (set_value('pekerjaan_ibu')) ? set_value('pekerjaan_ibu') : $mhs['pekerjaan_ibu']; ?>">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="tanggungan" class="form-control" id="tanggungan" placeholder="Tanggungan Orang Tua" value="<?= (set_value('tanggungan')) ? set_value('tanggungan') : $mhs['tanggungan']; ?>">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="penghasilan_ortu" class="form-control" id="penghasilan_ortu" placeholder="Penghasilan Orang Tua" value="<?= (set_value('penghasilan_ortu')) ? set_value('penghasilan_ortu') : $mhs['penghasilan_ortu']; ?>">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="nama_bank" class="form-control" id="nama_bank" placeholder="Nama Bank" value="<?= (set_value('nama_bank')) ? set_value('nama_bank') : $mhs['nama_bank']; ?>">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="norek_bank" class="form-control" id="norek_bank" placeholder="No Rekening Bank" value="<?= (set_value('norek_bank')) ? set_value('norek_bank') : $mhs['norek_bank']; ?>">
                    ...
                    <label for="id_usulan">Tahun Usulan</label>
                        <select class="form-control" tabindex="-1" aria-hidden="true" name="id_usulan">
                            <option value="<?php echo $mhs['id_usulan']; ?>"><?php echo $mhs['tahun']; ?></option>

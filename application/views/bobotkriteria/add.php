...
<div class="content-wrapper">
    ...
    <section class="content">
        ...
        <h3><?= $title; ?></h3>
        <form action="<?= base_url('bobotkriteria/bobotkriteria_tambah'); ?>" method="POST">
        ...
        <div class=" form-group">
            ...
            <input type="text" name="kriteria_ipk" class="form-control" id="kriteria_ipk" placeholder="Kriteria IPK" value="<?= set_value('kriteria_ipk'); ?>">
        ...
        <div class=" form-group">
            ...
            <input type="text" name="kriteria_prestasi" class="form-control" id="kriteria_prestasi" placeholder="Kriteria Prestasi" value="<?= set_value('kriteria_prestasi'); ?>">
        ...
        <div class=" form-group">
            ...
            <input type="text" name="kriteria_penghasilan" class="form-control" id="kriteria_penghasilan" placeholder="Kriteria Penghasilan" value="<?= set_value('kriteria_penghasilan'); ?>">
